...
- When updating cross-tool capability documentation, use `skills/documentation-steward/SKILL.md` and follow its verification workflow.
...
- If capability docs need to be updated, use `skills/documentation-steward/SKILL.md` and follow its verification workflow before changing support labels.
