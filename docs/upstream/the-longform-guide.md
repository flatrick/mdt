...
I've built these hooks and they're in the repo at `github.com/flatrick/modeldev-toolkit/tree/main/hooks`
...
*Everything covered in both guides is available on GitHub at [modeldev-toolkit](https://github.com/flatrick/modeldev-toolkit)*
