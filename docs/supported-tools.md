...
- Codex officially supports layered `AGENTS.md`, rule files, skills, and built-in slash commands. MDT now installs package-selected Codex skills and project runtime helpers in addition to `~/.codex` config.
