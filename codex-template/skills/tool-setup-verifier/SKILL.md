...
Use this skill when auditing MDT's local Codex adapter, validating documented
Codex workflow coverage, or producing a Codex readiness report without relying
on CI or live model calls.
