...
class SkillCreateOutput {
  ...
  header() {
    ...
    console.log(chalk.bold(chalk.magenta('║')) + chalk.bold('  🔮 MDT Skill Creator                                          ') + chalk.bold(chalk.magenta('║')));
...
`));
  ...
  footer() {
    ...
    console.log(chalk.dim(`  Powered by ModelDev Toolkit • MDT.tools`));
...
async function demo() {
  ...
  output.output(
    '<config>/skills/pmx-patterns/SKILL.md',
    '<data>/homunculus/instincts/inherited/pmx-instincts.yaml'
  );
